...
#SBATCH --output=kymata-core-data/output/qwen_english_meg/encoder/log/cai/slurm_log_%a.txt
#SBATCH --error=kymata-core-data/output/qwen_english_meg/encoder/log/cai/slurm_log_%a.txt
#SBATCH --ntasks=1
...
echo "Reading neuron list from npy (subrange Cai: [16000, 28661))"
...
out=$("$VENV_PYTHON" kymata/invokers/read_npy.py "$npy_file" --range 16000 28661 --format bash)
