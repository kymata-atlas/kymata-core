...
#SBATCH --output=kymata-core-data/output/qwen_english_russian/sensor/decoder_text/log/slurm_log_%a.txt
#SBATCH --error=kymata-core-data/output/qwen_english_russian/sensor/decoder_text/log/slurm_log_%a.txt
#SBATCH --ntasks=1
