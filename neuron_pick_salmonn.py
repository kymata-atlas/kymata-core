...
def asr_models_loop_full():
    ...
    compare_log_dir = f'/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/size/salmonn_13b/fc2/log/'
    tvl_compare_log_dir = '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/size/salmonn_13b/tvl/log/'
    tvl_log_dir = '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/salmonn_13b_phone/tvl/log/'
    ...
    if figure_opt == 'phone':
        feats_path = f'/imaging/projects/cbu/kymata/analyses/tianyi/workspace/output/corr/salmonn_13B_{figure_opt}_pvalue.npy'
        ...
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/phone_sig.npy', np.array(neuron_picks))
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/id_sig.npy', np.array(neuron_picks_id))
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/art_sig.npy', np.array(neuron_picks_art))
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/other_phone_sig.npy', np.array(neuron_pick_other))
        ...
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/word_sig.npy', np.array(neuron_picks))
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/sem_sig.npy', np.array(neuron_picks_sem))
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/lex_sig.npy', np.array(neuron_picks_lex))
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/pos_sig.npy', np.array(neuron_picks_pos))
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/syn_sig.npy', np.array(neuron_picks_syn))
        np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_13B/other_word_sig.npy', np.array(neuron_pick_other))
        print(counter_vector)
