...
#SBATCH --output=kymata-core-data/output/first_speech_paper/all_wordpiece_source/slurm_log_batch_3.txt
#SBATCH --error=kymata-core-data/output/first_speech_paper/all_wordpiece_source/slurm_log_batch_3.txt
#SBATCH --ntasks=1
...
npy_file='/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks/wordpiece_all.npy'
...
python kymata/invokers/run_gridsearch.py \
  ...
  --asr-option 'some' \
  --mfa True \
  --save-plot-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/first_speech_paper/all_wordpiece_source/batch_3' \
  --save-expression-set-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/first_speech_paper/all_wordpiece_source/batch_3' \
