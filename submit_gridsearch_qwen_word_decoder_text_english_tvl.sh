...
#SBATCH --output=kymata-core-data/output/qwen_english/sensor/decoder_text/tvl/log/slurm_log_%a.txt
#SBATCH --error=kymata-core-data/output/qwen_english/sensor/decoder_text/tvl/log/slurm_log_%a.txt
#SBATCH --ntasks=1
...
python kymata/invokers/run_gridsearch.py \
  ...
  --low-level-function \
  --n-splits 400 \
  --save-plot-location "/imaging/projects/cbu/kymata/analyses/tianyi/russian-english/kymata-core/kymata-core-data/output/qwen_english/sensor/decoder_text/tvl/expression/${layer_num[$SLURM_ARRAY_TASK_ID]}" \
  --save-expression-set-location "/imaging/projects/cbu/kymata/analyses/tianyi/russian-english/kymata-core/kymata-core-data/output/qwen_english/sensor/decoder_text/tvl/expression/${layer_num[$SLURM_ARRAY_TASK_ID]}" \
  --start-latency -0.5 \
  --overwrite
