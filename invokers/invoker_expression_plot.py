...
output_path = 'C:/Users/cy02/Documents/GitHub/kymata-toolbox/kymata-toolbox-data/output'
expression_data_new_results = load_expression_set(from_path_or_file=output_path+'/IL_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/output/IL1_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/output/IL2_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/output/IL3_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'output/IL4_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/output/IL5_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/output/IL6_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/output/IL7_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/output/IL8_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/output/IL9_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/output/STL_gridsearch.nkg')
