...
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/IL1_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/IL2_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/IL3_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/IL4_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/IL5_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/IL6_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/IL7_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/IL8_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/IL9_gridsearch.nkg')
expression_data_new_results += load_expression_set(from_path_or_file=output_path+'/STL_gridsearch.nkg')
