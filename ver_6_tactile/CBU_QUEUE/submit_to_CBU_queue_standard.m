...
functionname = 'LHIndexToelowfluct';
stimulisigFunctionName = 'LHIndexFingerslowfluctSplit';
inputstream = 'tactile';
functionlocation = ['/raw/'];
inputfolder = ['vert10242-nodepth-diagonly-snr1-signed-fsaverage-baselineNone/'];
...
workerpath={'/imaging/at03/NKG_Code/Version6_tactile/CBU_QUEUE'};
...
for i=1:njob
    ...
    jobs(i).input_args={char(handedness(i)), functionname, functionlocation, stimulisigFunctionName, cutoff, nWords, nTimePoints, nVertices, outputfolder, inputfolder};
end
