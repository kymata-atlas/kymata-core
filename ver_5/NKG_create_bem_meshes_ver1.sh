...
SUBJECTS_DIR='/imaging/at03/NKG_Data_Sets/DATASET_1-01_visual-only/mne_subjects_dir/'    # root directory for MRI data
...
do
        ...
        mne_setup_source_space --spacing 4 --overwrite --subject ${subjects[m]} --cps
done
