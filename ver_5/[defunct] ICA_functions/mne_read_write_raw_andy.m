function mne_read_write_raw_eli(RawFile,OutFile,new_data)
%
...
tempdigidata = fiff_read_evoked(['/imaging/ef02/phrasal/', char(participentIDlist(p)) , '/raw/', char(participentIDlist(p)), '_part1_avg.fif']);
