...
subjects_dir = '/imaging/at03/NKG_Data_Sets/DATASET_3-01_visual-and-auditory/mne_subjects_dir'
...
for p in participants:
	...
	for w in words:
		...
		if (evoked.nave > 0):
			...
			stc_morphed.save((data_path + '/4-single-trial-source-data/vert10242-nodepth-diagonly-snr1-signed-baselineNone/' + p + '-' + w))
