...
mne_do_forward_solution --subject ${subjects[m]} --mindist 5 --ico 5 --bem ${mne_sub}${subjects[m]}/bem/${subjectsX[m]}-5120-5120-5120-bem-sol.fif --src ${mne_sub}${subjects[m]}/bem/${subjectsX[m]}-4-src.fif --meas ${code_output_path}3-sensor-data/fif-out/audio/'meg15_'${subjects[m]}-grandave.fif --fwd ${code_output_path}3-sensor-data/forward-models/meg15_${subjects[m]}_ico-5-3L-fwd.fif
