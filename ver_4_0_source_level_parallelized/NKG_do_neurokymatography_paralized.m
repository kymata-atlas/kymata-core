...
nTimePoints = 2066;                                                                 % number of time points in raw data
...
outputSTC = mne_read_stc_file([rootCodeOutputPath 'Version4_source_level_CUDA/' experimentName, '/3-averaged-by-trial-data/averagemesh-vert2562-smooth5-elisinvsol/gave270psuedo/' char(wordlist(1)) '-' leftright '.stc']);
...
for w = 1:numel(wordlist) 
    ...
    inputfilename = [rootCodeOutputPath 'Version4_source_level_CUDA/' experimentName, '/3-averaged-by-trial-data/averagemesh-vert2562-smooth5-elisinvsol/gave270psuedo/', thisword '-' leftright '.stc'];
...
% outputSTC.data = nthroot(outputSTC.data,1.5);
...
outputSTC.tmin = -0.2;
mne_write_stc_file( [rootCodeOutputPath 'Version4_source_level_CUDA/' experimentName, '/5-neurokymography-output/averagemesh-vert2562-smooth5-elisinvsol/test-' leftright '.stc'], outputSTC);
