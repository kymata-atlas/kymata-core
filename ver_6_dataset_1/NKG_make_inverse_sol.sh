...
datacode_path="/imaging/at03/NKG_Code_output/Version5/DATASET_1-01_visual-only/"
...
mne_inverse_operator --csd --exclude $path${subjects[m]}/label/Destrieux_Atlas/Unknown-lh.label --exclude $path${subjects[m]}/label/Destrieux_Atlas/Unknown-rh.label --fwd ${datacode_path}3-sensor-data/forward-models/meg14_${subjects[m]}_ico-5-3L-fwd.fif --diagnoise --meg --eeg --loose 0.2 --senscov ${datacode_path}3-sensor-data/covarience-files/meg14_${subjects[m]}-auto-gcov.fif --magreg 0.1 --gradreg 0.1 --eegreg 0.1 --inv ${datacode_path}3-sensor-data/inverse-operators/meg14_${subjects[m]}_ico-5-3L-loose02-diagnoise-nodepth-reg-inv-csd.fif
