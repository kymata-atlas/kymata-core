...
for p = 1:numel(participentIDlist) 
    ...
    for b = 1:participentNumBlockHash.get(char(participentIDlist(p)))
        ...
        rawfname              = [rootDataSetPath, experimentName, '/', participentIDlist{p} '/nkg_part' num2str(b) '_raw.fif'];
        ...
        nameoffirstblock      = [rootDataSetPath, experimentName, '/', participentIDlist{p} '/nkg_part' num2str(1) '_raw.fif'];
