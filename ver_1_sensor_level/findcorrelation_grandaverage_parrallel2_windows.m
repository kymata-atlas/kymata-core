...
%addpath //home/opt/neuromag/meg_pd_1.2/
addpath //home/imaging/Fieldtrip/
%addpath /opt/mne/matlab/toolbox/
addpath //home/imaging/Fieldtrip/fileio/
addpath //home/imaging/NKG/
...
wordlistFilename = ['//home/imaging/LexproMEG/scripts/Simuli-Lexpro-MEG-Single-col.txt'];
...
outputpath = ['//home/Named_Screenshots/CO/13-ztest_fishertrans__GR_thenrms_7window_nofilter_all_participants_megrealigned_cutoffat600_upsampled_pequals0.000001'];
latencies = [50 75 100 150 175 200 250 300 350 400];
...
for k = 1:length(latencies);
    ...
    for i = 1:length(words) % for each word
    ...
    %outputfile = [outputpath, '/latency-', num2str(latency),'_pval-', sigstring, '.jpg'];
    %saveas(gcf, outputfile);
    xxx = ['//home/at03/Desktop/temp' num2str(round(rand(1)*1000)) '.jpg'];
    saveas(gcf, xxx);
    %close(gcf);
