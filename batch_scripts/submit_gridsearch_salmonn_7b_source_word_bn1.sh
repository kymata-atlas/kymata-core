...
#SBATCH --output=kymata-core-data/output/first_speech_paper/all_word_source/slurm_log_batch_n1.txt
#SBATCH --error=kymata-core-data/output/first_speech_paper/all_word_source/slurm_log_batch_n1.txt
#SBATCH --ntasks=1
...
python kymata/invokers/run_gridsearch.py \
  ...
  --asr-option 'some' \
  --mfa True \
  --save-plot-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/first_speech_paper/all_word_source/batch_n1' \
  --save-expression-set-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/first_speech_paper/all_word_source/batch_n1' \
