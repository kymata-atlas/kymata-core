...
#SBATCH --output=kymata-core-data/output/qwen_english_russian/sensor/decoder_text/pilot_04/log/slurm_log_%a.txt
#SBATCH --error=kymata-core-data/output/qwen_english_russian/sensor/decoder_text/pilot_04/log/slurm_log_%a.txt
#SBATCH --ntasks=1
...
python kymata/invokers/run_gridsearch.py \
  ...
  --mfa True \
  --n-splits 400 \
  --save-plot-location "/imaging/projects/cbu/kymata/analyses/tianyi/russian-english/kymata-core/kymata-core-data/output/qwen_english_russian/sensor/decoder_text/pilot_04/expression" \
  --save-expression-set-location "/imaging/projects/cbu/kymata/analyses/tianyi/russian-english/kymata-core/kymata-core-data/output/qwen_english_russian/sensor/decoder_text/pilot_04/expression" \
  --overwrite \
  --single-participant-override 'pilot_04' \
