...
#   sbatch submit_gridsearch_ru_en.sh
###
  ...
  bash -c \
    " cd /imaging/projects/cbu/kymata/analyses/tianyi/kymata-core ; \
      ...
      \$VENV_PATH/bin/poetry run python -m kymata.invokers.run_gridsearch \
        ...
        --transform-path 'predicted_function_contours/GMloudness_TVL_and_hilbert/stimulisig' \
        --transform-name IL STL IL1 IL2 IL3 IL4 IL5 IL6 IL7 IL8 IL9  \
        --save-expression-set-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/ru_en/all_pilots/tvl' \
        --save-plot-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/ru_en/all_pilots/tvl' \
        --save-name 'all_tvl' \
        --overwrite \
