...
#SBATCH --output=kymata-core-data/output/first_speech_paper/all_morpheme_source/slurm_log_batch_n.txt
#SBATCH --error=kymata-core-data/output/first_speech_paper/all_morpheme_source/slurm_log_batch_n.txt
#SBATCH --ntasks=1
...
npy_file='/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks/new_batch/morpheme.npy'
...
python kymata/invokers/run_gridsearch.py \
  ...
  --asr-option 'some' \
  --mfa True \
  --save-plot-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/first_speech_paper/all_morpheme_source/batch_n' \
  --save-expression-set-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/first_speech_paper/all_morpheme_source/batch_n' \
