  ...
  bash -c \
    " cd /imaging/woolgar/projects/Tianyi/kymata-core ; \
      ...
      \$VENV_PATH/bin/poetry run python -m invokers.run_gridsearch \
        ...
        --save-expression-set-location '/imaging/woolgar/projects/Tianyi/kymata-core/kymata-core-data' \
        --save-plot-location '/imaging/woolgar/projects/Tianyi/kymata-core/kymata-core-data' \
        --overwrite \
        --morph \
  "
  #  --snr $ARG # >> result3.txt
