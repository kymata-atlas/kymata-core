  ...
  bash -c \
    " cd /imaging/woolgar/projects/Tianyi/kymata-toolbox/ ; \
      ...
      \$VENV_PATH/bin/poetry run python -m invokers.run_gridsearch \
        ...
        --asr-option 'all' \
        --num-neurons 1280 \
        --save-plot-location '/imaging/woolgar/projects/Tianyi/kymata-toolbox/kymata-toolbox-data/output/whisper_large_ru/decoder_all_der_5/plot/${layer_num[$(($SLURM_ARRAY_TASK_ID))]}' \
        --save-expression-set-location '/imaging/woolgar/projects/Tianyi/kymata-toolbox/kymata-toolbox-data/output/whisper_large_ru/decoder_all_der_5/expression_set/${layer_num[$(($SLURM_ARRAY_TASK_ID))]}' \
  "
