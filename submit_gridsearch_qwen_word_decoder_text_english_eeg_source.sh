...
#SBATCH --output=kymata-core-data/output/qwen_english_eeg/decoder/log/slurm_log_%a.txt
#SBATCH --error=kymata-core-data/output/qwen_english_eeg/decoder/log/slurm_log_%a.txt
#SBATCH --ntasks=1
...
npy_file='/imaging/projects/cbu/kymata/analyses/tianyi/russian-english/kymata-core/kymata-core-data/output/qwen_english_eeg/decoder/sig_neurons_eeg.npy'
...
out=$(python kymata/invokers/read_npy.py "$npy_file" --range 0 330 --format bash)
...
python kymata/invokers/run_gridsearch.py \
  ...
  --mfa True \
  --n-splits 400 \
  --save-plot-location "/imaging/projects/cbu/kymata/analyses/tianyi/russian-english/kymata-core/kymata-core-data/output/qwen_english_eeg/decoder/expression/task_${SLURM_ARRAY_TASK_ID}" \
  --save-expression-set-location "/imaging/projects/cbu/kymata/analyses/tianyi/russian-english/kymata-core/kymata-core-data/output/qwen_english_eeg/decoder/expression/task_${SLURM_ARRAY_TASK_ID}" \
