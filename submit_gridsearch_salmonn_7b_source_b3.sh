...
#SBATCH --output=kymata-core-data/output/paper/word_source/slurm_log_batch_3.txt
#SBATCH --error=kymata-core-data/output/paper/word_source/slurm_log_batch_3.txt
#SBATCH --ntasks=1
...
apptainer exec \
  ...
  bash -c "
    ...
    \$VENV_PATH/bin/poetry run python -m invokers.run_gridsearch \
      ...
      --asr-option 'some' \
      --mfa True \
      --save-plot-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/word_source/batch_3' \
      --save-expression-set-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/word_source/batch_3' \
