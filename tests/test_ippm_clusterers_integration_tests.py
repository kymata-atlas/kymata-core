...
from kymata.ippm.cluster import (
    MaxPoolClusterer, AdaptiveMaxPoolClusterer, GMMClusterer, points_to_matrix)

# no data
test_case_no_data = points_to_matrix([])

# starting with insignificant bin
test_case_start_insignif = points_to_matrix([
...
test_case_end_insignif = points_to_matrix([
...
# all insignificant
test_case_all_insignif = points_to_matrix([
...
test_case_start_end_signif = points_to_matrix([
...
test_case_all_signif = points_to_matrix([
