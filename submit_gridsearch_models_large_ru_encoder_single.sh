...
#   sbatch submit_gridsearch_models_large_ru_encoder_single.sh
###
  ...
  bash -c \
    " cd /imaging/woolgar/projects/Tianyi/kymata-toolbox/ ; \
      ...
      \$VENV_PATH/bin/poetry run python -m invokers.run_gridsearch \
        ...
        --function-name 'model.encoder.layers.31.final_layer_norm' \
        --n-derangements 5 \
        --asr-option 'all' \
        --num-neurons 1280 \
        --save-plot-location '/imaging/woolgar/projects/Tianyi/kymata-toolbox/kymata-toolbox-data/output/russian/whisper_large_encoder/plot/model.encoder.layers.31.final_layer_norm' \
        --save-expression-set-location '/imaging/woolgar/projects/Tianyi/kymata-toolbox/kymata-toolbox-data/output/russian/whisper_large_encoder/expression_set/model.encoder.layers.31.final_layer_norm' \
  "
