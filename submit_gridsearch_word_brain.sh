...
#   sbatch submit_gridsearch_word_brain.sh
###
  ...
  bash -c \
    " cd /imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/ ; \
      ...
      \$VENV_PATH/bin/poetry run python -m invokers.run_gridsearch \
        ...
        --plot-top-channels \
        --function-path '/imaging/projects/cbu/kymata/data/dataset_4-english_narratives/predicted_function_contours/linguistics/word_with_class_time' \
        --num-neurons 23 \
        --function-name 'word' \
        --n-derangements 5 \
