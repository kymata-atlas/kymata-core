...
#SBATCH --output=kymata-core-data/output/paper/morpheme_source/b2/slurm_log.txt
#SBATCH --error=kymata-core-data/output/paper/morpheme_source/b2/slurm_log.txt
#SBATCH --ntasks=1
...
apptainer exec \
  ...
  bash -c "
    ...
    \$VENV_PATH/bin/poetry run python -m kymata.invokers.run_gridsearch \
      ...
      --asr-option 'some' \
      --mfa True \
      --save-plot-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/morpheme_source/b2' \
      --save-expression-set-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/morpheme_source/b2' \
