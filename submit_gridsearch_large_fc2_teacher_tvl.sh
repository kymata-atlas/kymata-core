...
#   sbatch submit_gridsearch_large_fc2_teacher_tvl.sh
###


#SBATCH --job-name=gridsearch
#SBATCH --output=kymata-core-data/output/paper/large/tvl/log/slurm_log_%a.txt
#SBATCH --error=kymata-core-data/output/paper/large/tvl/log/slurm_log_%a.txt
#SBATCH --ntasks=1
  ...
  bash -c \
    " cd /imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/ ; \
      ...
      \$VENV_PATH/bin/poetry run python -m invokers.run_gridsearch \
        ...
        --asr-option 'all' \
        --mfa True \
        --save-plot-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/large/tvl/plot/${layer_num[$(($SLURM_ARRAY_TASK_ID))]}' \
        --save-expression-set-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/large/tvl/expression_set/${layer_num[$(($SLURM_ARRAY_TASK_ID))]}' \
        --low-level-function \
        --start-latency -500 \
  "
