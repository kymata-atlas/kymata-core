...
#   sbatch submit_gridsearch_large_ru_ind_3.sh
###


#SBATCH --job-name=gridsearch
#SBATCH --output=kymata-core-data/output/ccn_paper/ru/meg15_0081/log/slurm_log_%a.txt
#SBATCH --error=kymata-core-data/output/ccn_paper/ru/meg15_0081/log/slurm_log_%a.txt
#SBATCH --ntasks=1
