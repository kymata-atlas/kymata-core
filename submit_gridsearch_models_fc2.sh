...
#   sbatch submit_gridsearch_models_fc2.sh
###


#SBATCH --job-name=gridsearch
#SBATCH --output=kymata-core-data/output/fc2_test/mfa/log/slurm_log_%a.txt
#SBATCH --error=kymata-core-data/output/fc2_test/mfa/log/slurm_log_%a.txt
#SBATCH --ntasks=1
  ...
  bash -c \
    " cd /imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/ ; \
      ...
      \$VENV_PATH/bin/poetry run python -m invokers.run_gridsearch \
        ...
        --asr-option 'all' \
        --num-neurons 1280 \
        --save-plot-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/fc2_test/mfa/plot/${layer_num[$(($SLURM_ARRAY_TASK_ID))]}' \
        --save-expression-set-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/fc2_test/mfa/expression_set/${layer_num[$(($SLURM_ARRAY_TASK_ID))]}' \
  "
