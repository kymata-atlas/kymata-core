...
def estimate_noise_cov(data_root_dir: str,
    ...
    for p in list_of_participants:
        if cov_method == 'grandave':
            ...
            mne.write_cov(data_root_dir + dataset_directory_name + '/intrim_preprocessing_files/3_evoked_sensor_data/covariance_grand_average/' + p + '-auto-grandave-cov.fif', cov)
            ...
            if duration_emp == None:
                mne.write_cov(data_root_dir + dataset_directory_name + '/intrim_preprocessing_files/3_evoked_sensor_data/covariance_grand_average/' + p + '-auto-emptyroom-cov.fif', cov)
            else:
                mne.write_cov(data_root_dir + dataset_directory_name + '/intrim_preprocessing_files/3_evoked_sensor_data/covariance_grand_average/' + p + '-auto-emptyroom' + str(duration_emp) + '-cov.fif', cov)
            ...
            cov = mne.compute_covariance(raw_epoch, tmin=0, tmax=None, method=reg_method, return_estimators=True)
            mne.write_cov(data_root_dir + dataset_directory_name + '/intrim_preprocessing_files/3_evoked_sensor_data/covariance_grand_average/' + p + '-auto-runstart-cov.fif', cov)
            ...
            mne.write_cov(data_root_dir + dataset_directory_name + '/intrim_preprocessing_files/3_evoked_sensor_data/covariance_grand_average/' + p + '-auto-fusion-cov.fif', cov)
