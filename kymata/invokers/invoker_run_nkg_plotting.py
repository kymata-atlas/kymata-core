...
def main():
    ...
    if function_family_type == "standard":
        expression_data = load_expression_set(
            Path(path_to_nkg_files, 'with_13_derange_10_1ms_interval', 'left', "3_transforms_gridsearch.nkg")
        )
        ...
        expression_data += load_expression_set(
            Path(path_to_nkg_files, 'with_13_derange_10_1ms_interval', 'right', "3_transforms_gridsearch.nkg")
        )
        ...
        expression_data += load_expression_set(
            Path(path_to_nkg_files, 'with_13_derange_10_1ms_interval', 'added', "3_transforms_gridsearch.nkg")
        )
