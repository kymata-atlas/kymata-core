...
if __name__ == "__main__":
    ...
    expression_data += load_matab_expression_files(
        ...
        lh_file=Path(sample_data_dir, "hornschunck_horizontalVelocity_lh_10242verts_-200-800ms_cuttoff1000_5perms_ttestpval.mat"),
        rh_file=Path(sample_data_dir, "hornschunck_horizontalVelocity_rh_10242verts_-200-800ms_cuttoff1000_5perms_ttestpval.mat"),
        flipped_lh_file=Path(sample_data_dir, "hornschunck_horizontalVelocity-flipped_lh_10242verts_-200-800ms_cuttoff1000_5perms_ttestpval.mat"),
        flipped_rh_file=Path(sample_data_dir, "hornschunck_horizontalVelocity-flipped_rh_10242verts_-200-800ms_cuttoff1000_5perms_ttestpval.mat"),
    )
    expression_data += load_matab_expression_files(
