...
#SBATCH --output=kymata-core-data/output/first_speech_paper/all_wordpiece_source/slurm_log_batch_4.txt
#SBATCH --error=kymata-core-data/output/first_speech_paper/all_wordpiece_source/slurm_log_batch_4.txt
#SBATCH --ntasks=1
...
python kymata/invokers/run_gridsearch.py \
  ...
  --asr-option 'some' \
  --mfa True \
  --save-plot-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/first_speech_paper/all_wordpiece_source/batch_4' \
  --save-expression-set-location '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/first_speech_paper/all_wordpiece_source/batch_4' \
