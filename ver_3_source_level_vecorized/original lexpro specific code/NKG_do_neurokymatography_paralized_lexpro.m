...
nTimePoints = 1852;                                                                 % number of time points in raw data
...
outputSTC = mne_read_stc_file([rootCodeOutputPath 'Version4_0_source_level_CUDA/' experimentName, '/3-averaged-by-trial-data/averagemesh-vert2562-smooth5-elisinvsol/' char(wordlist(1)) '-' leftright '.stc']);
...
for w = 1:numel(wordlist) 
    ...
    inputfilename = [rootCodeOutputPath 'Version4_0_source_level_CUDA/' experimentName, '/3-averaged-by-trial-data/averagemesh-vert2562-smooth5-elisinvsol/', thisword '-' leftright '.stc'];
...
outputSTC.tmin = -0.2;
mne_write_stc_file( [rootCodeOutputPath 'Version4_0_source_level_parallelised/' experimentName, '/5-neurokymography-output/averagemesh-vert642-smooth5-elisinvsol/test-' leftright '.stc'], outputSTC);
