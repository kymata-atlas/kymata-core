...
def asr_models_loop_full():
    ...
    # log_dir = '/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/paper/size/large/fc2/log/'
    ...
    np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_v2_excl_tvl/word_sig.npy', np.array(neuron_picks))
    np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_v2_excl_tvl/sem_sig.npy', np.array(neuron_picks_sem))
    np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_v2_excl_tvl/lex_sig.npy', np.array(neuron_picks_lex))
    np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_v2_excl_tvl/pos_sig.npy', np.array(neuron_picks_pos))
    np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_v2_excl_tvl/syn_sig.npy', np.array(neuron_picks_syn))
    np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_v2_excl_tvl/other_word_sig.npy', np.array(neuron_pick_other))
    # np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_excl_tvl/word_sig.npy', np.array(neuron_picks))
    # np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_excl_tvl/sem_sig.npy', np.array(neuron_picks_sem))
    # np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_excl_tvl/lex_sig.npy', np.array(neuron_picks_lex))
    # np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_excl_tvl/pos_sig.npy', np.array(neuron_picks_pos))
    # np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_excl_tvl/syn_sig.npy', np.array(neuron_picks_syn))
    # np.save('/imaging/projects/cbu/kymata/analyses/tianyi/kymata-core/kymata-core-data/output/neuron_picks_whisper_excl_tvl/other_word_sig.npy', np.array(neuron_pick_other))
    print(counter_vector)
    print(len(neuron_picks))
