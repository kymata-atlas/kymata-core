...
if isStandard == 1
    ...
    nVertices = 10242;  
    inputfolder = 'vert10242-smooth5-nodepth-corFM-snr1-signed-fsaverage-noMedWall-csd-minus30';
    outputfolder = 'averagemesh-vert10242-smooth5-corinvsol-fsaverage-noMedWall-csd-minus30';
end
