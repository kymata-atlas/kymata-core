...
nTimePoints = 2068;
nWords = 480;
subject = char(participentIDlist(i));

% 
% leftright = 'rh';
%functionname = 'ins_loudness';
%functionlocation = '/Glasberg-Moore_Loudness/';
%stimulisigFunctionName = 'loudnessinstantSones';
% isStandard = 1;
% cutoff = 1000; 
% nTimePoints = 2068;
% nWords = 480;
...
if isStandard == 1
    ...
    inputfolder = 'vert2562-smooth5-nodepth-corFM-snr1-signed';
else
    nVertices = 10242;  
...
tasks={'NKG_do_neurokymatography_standard_RandomEffectsTest'};
tasks=tasks(1);
...
jobs(1).input_args={subject,leftright, functionname, functionlocation, stimulisigFunctionName, cutoff, nWords, nTimePoints, nVertices, outputfolder, inputfolder};
