...
cd(fullfile(rootCodeOutputPath, version, experimentName, '5-backedup-mat-files', outputfolder));
save('-v7.3',[functionname '_' leftright '_' num2str(nVertices) 'verts_-200-800ms_cuttoff' num2str(cutoff) '_' num2str(numberOfIterations) 'perms_ranksumpval_NegitiveIsZero_snr1_nodepth'], 'outputSTC', 'functionname', 'leftright', 'latencies', 'latency_step', 'length_of_longest_stimuli', 'nTimePoints', 'nVertices', 'nWords', 'numberOfIterations');
