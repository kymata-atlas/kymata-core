...
dataset, sampling_rate = librosa.load('/imaging/projects/cbu/kymata/data/open-source/ERP_CORE/MMN All Data and Scripts/Stimuli/standard_2s.wav', sr=16_000)
...
# func_name = 'whisper_all_no_reshape_medium'
func_name = 'whisper_aerp_base'
